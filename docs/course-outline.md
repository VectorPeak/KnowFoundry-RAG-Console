...
| P3 扩展方向 | OCR/VLM、GraphRAG、GraphRAG Agent、Router/Planner、LangGraph Agent、A2A、容量评估 | 知道边界和规划即可，不放进第一遍主线。 |
...
**路线图的设计逻辑**：19 讲遵循"基础概念 → 框架基础（LangChain）→ 核心链路 → Web 基础设施 → 治理运维"的递进。学生先建立 RAG 概念和 LangChain 体系认知，再在 7 讲实战中反复应用，最后补上 Web 服务层和企业级治理能力。
